         ...
         <div class="card">
            ...
            <form action="{{ url('nonaktif/'.$nonaktif->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kd_servis" name="kode_nonaktif" value="{{ $nonaktif->kode_nonaktif }}" readonly>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-select mb-3 shadow-none" name="id_lokasi" id="id_lokasi">
                            ...
                            <option value="{{ $nonaktif->id_lokasi }}">{{ $nonaktif->lokasi->nama_lokasibarang }}</option>
                            @foreach ($lokasi as $l)
                        ...
                        <select class="form-select mb-3 shadow-none" name="id_status" id="id_lokasi">
                            ...
                            <option value="{{ $nonaktif->id_status }}">{{ $nonaktif->status->nama_statusbarang }}</option>
                            @foreach ($status as $s)
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="{{ $nonaktif->deskripsi }}" placeholder="Input deskripsi...">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="jumlah"><b>Jumlah</b></label>
                        <input type="text" class="form-control" id="jumlah" name="jumlah" value="{{ $nonaktif->jumlah }}" placeholder="Input jumlah...">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="tgl_nonaktif"><b>Tanggal Nonaktif</b></label>
                        <input type="date" class="form-control" id="tgl_nonaktif" name="tanggal_nonaktif" value="{{ $nonaktif->tanggal_nonaktif }}">
                    </div><br><br>
