...
#serviceproduct td, #serviceproduct th {
  border: 1px solid #ddd;
  padding: 8px;
}

#serviceproduct tr:nth-child(even){background-color: #f2f2f2;}

#serviceproduct tr:hover {background-color: #ddd;}
...
<center><h1>Laporan Data Barang di Servis</h1></center>
