        ...
        <div class="card-body">
            <form action="{{ url('ajukanpinjamruangan/'.$reqpinjam->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kd_peminjaman" name="id" value="{{ $reqpinjam->id }}"
                        placeholder="dibangkitkan otomatis" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select mb-3 shadow-none" name="nama_gedung" id="id_gedung">
                        ...
                        <option value="{{ $reqpinjam->id_building }}">{{ $reqpinjam->gudang->nama_gedung }}</option>
                        @foreach ($gudang as $g)
...
=======
            <div class="card-body">
                <form action="{{ url('ajukanpinjamruangan/'.$reqpinjam->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="tanggal_pinjam"><b>Tanggal Pinjam</b></label>
                        <input type="date" class="form-control" id="tanggal_pinjam" name="tanggal_pinjam"  value="{{ $reqpinjam->tanggal_pinjam }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="tgl_selesai"><b>Tanggal Selesai</b></label>
                        <input type="date" class="form-control" id="tgl_selesai" name="tanggal_selesai" value="{{ $reqpinjam->tanggal_selesai }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="status"><b>Status</b></label>
                        <input type="text" class="form-control" name="status" value=diajukan readonly>
...
>>>>>>> e392b2feb5e395c17a0c4085bec48c918e109be8
@endsection